    ...
    <div className='py-10 bg-gray-50'>
        <div className="container mx-auto px-6">
            <div className="text-center mb-16">
                <h1 className='text-3xl md:text-4xl text-darl font-bold mb-6'>Choose Hosting Plan</h1>
                <p className='mx-auto text-dark/80 max-w-md'>Globally incubate next-generation e-services via state of the art technology.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <ul className='mt-8 space-y-4'>
                    ...
                    <li className='flex items-center gap-2'>
                        <FaCheckCircle className='text-primary'/>
                        <span className='text-dark/80'>10 GB Storage</span>
                    </li>
                    <li className='flex items-center gap-2'>
                        <FaCheckCircle className='text-primary'/>
                        <span className='text-dark/80'>Unlimited Badnwidth</span>
                    </li>
                    <li className='flex items-center gap-2'>
                        <FaCheckCircle className='text-primary'/>
                ...
                <div className="bg-white relative rounded-2xl shadow overflow-hidden p-10 border border-primary/70">
                <div className='absolute py-2 bg-primary text-white px-6 rounded-tr-2xl rounded-bl-2xl top-0 right-0'>
                    <span>Popular</span>
                </div>
                <h3 className='text-3xl text-dark font-bold mb-6'>Busniess</h3>
                <p className='text-dark/80 mb-8'>Ideal for business growing</p>
                <p className='text-dark/80 mb-8'>
                <span className='text-3xl text-dark font-bold'>$5.99</span>
                <span>/month</span>
                </p>
                <button className='w-full px-6 py-2.5 bg-primary text-white font-semibold rounded text-center cursor-pointer'>Get Started</button>
                <ul className='mt-8 space-y-4'>
                    <li className='flex items-center gap-2'>
                        <FaCheckCircle className='text-primary'/>
                    ...
                    <li className='flex items-center gap-2'>
                        <FaCheckCircle className='text-primary'/>
                        <span className='text-dark/80'>50 GB Storage</span>
                    </li>
                    <li className='flex items-center gap-2'>
                        <FaCheckCircle className='text-primary'/>
                        <span className='text-dark/80'>Unlimited Badnwidth</span>
                ...
                <ul className='mt-8 space-y-4'>
                    ...
                    <li className='flex items-center gap-2'>
                        <FaCheckCircle className='text-primary'/>
                        <span className='text-dark/80'>200 GB Storage</span>
                    </li>
                    <li className='flex items-center gap-2'>
                        <FaCheckCircle className='text-primary'/>
                        <span className='text-dark/80'>Unlimited Badnwidth</span>
